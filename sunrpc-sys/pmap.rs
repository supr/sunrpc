...
pub type resultproc_t =
    ::std::option::Option<extern "C" fn
                              (__resp: caddr_t,
                               __raddr: *mut Struct_sockaddr_in) -> bool_t>;
pub enum Struct_pmaplist { }
...
extern "C" {
    ...
    pub fn pmap_set(__program: u_long, __vers: u_long,
                    __protocol: ::libc::c_int, __port: u_short) -> bool_t;
    pub fn pmap_unset(__program: u_long, __vers: u_long) -> bool_t;
    pub fn pmap_getmaps(__address: *mut Struct_sockaddr_in)
     -> *mut Struct_pmaplist;
    pub fn pmap_rmtcall(__addr: *mut Struct_sockaddr_in, __prog: u_long,
                        __vers: u_long, __proc: u_long, __xdrargs: xdrproc_t,
                        __argsp: caddr_t, __xdrres: xdrproc_t,
                        __resp: caddr_t, __tout: Struct_timeval,
                        __port_ptr: *mut u_long) -> Enum_clnt_stat;
    pub fn clnt_broadcast(__prog: u_long, __vers: u_long, __proc: u_long,
                          __xargs: xdrproc_t, __argsp: caddr_t,
                          __xresults: xdrproc_t, __resultsp: caddr_t,
                          __eachresult: resultproc_t) -> Enum_clnt_stat;
    pub fn pmap_getport(__address: *mut Struct_sockaddr_in, __program: u_long,
                        __version: u_long, __protocol: u_int) -> u_short;
}
